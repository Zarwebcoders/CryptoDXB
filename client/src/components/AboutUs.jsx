                    ...
                    <div className="flex-1 pr-0">
                        ...
                        >
                            ...
                            <p className="text-gray-500 text-md mb-8 leading-relaxed">
                                CryptoDXB bridges the gap between traditional banking reliability and DeFi innovation. We provide a secure, transparent, and high-yield platform for investors to grow their wealth through automated staking strategies.
                            </p>
