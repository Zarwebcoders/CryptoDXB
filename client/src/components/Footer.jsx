        ...
        <footer className="bg-[#0F172A] py-10 text-white border-t border-gold/20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex items-center gap-3 mb-6 bg-white/5 p-3 rounded-lg border border-white/5">
                            ...
                            <div>
                                ...
                                <a href="mailto:support@cryptodxb.com" className="text-white hover:text-gold transition-colors text-sm font-medium">
                                    support@cryptodxb.com
                                </a>
                            </div>
                        </div>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
                    <p>
                        © {new Date().getFullYear()} CryptoDXB. All rights reserved.
                    </p>
