...
const testimonials = [
    ...
    },
    {
        name: "Sarah Chen",
        role: "DeFi Analyst",
        content: "Security was my main concern, but CryptoDXB's transparent protocols and insurance coverage gave me peace of mind.",
    ...
    },
    {
        name: "Emma Wilson",
        role: "Web3 Developer",
        content: "The API integration is seamless. Built my entire dApp around CryptoDXB's smart contracts with zero issues.",
    ...
    },
    {
        name: "David Park",
        role: "Crypto Trader",
        content: "Daily rewards distribution is flawless. Never missed a single payment in my 18 months of using CryptoDXB.",
    ...
    },
    {
        ...
        content: "Recommended CryptoDXB to all my clients. The yield stability outperforms traditional investment options.",
        ...
        <section id="testimonials" className="py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    >
                        Join thousands of satisfied users who are growing their wealth with CryptoDXB's premium staking platform.
                    </motion.p>
                </div>
