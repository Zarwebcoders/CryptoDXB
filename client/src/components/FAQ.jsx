...
const FAQ = () => {
    ...
    const faqs = [
        {
            question: "What is CryptoDXB?",
            answer: "CryptoDXB is a decentralized finance (DeFi) platform that allows users to stake USDT and earn passive income through secure blockchain protocols. Our platform leverages cutting-edge smart contracts to provide transparent, reliable, and high-yield staking opportunities.",
                ...
                >
                    <div className="inline-flex flex-col items-center gap-6 bg-gradient-to-br from-white to-gray-50 rounded-3xl p-8 shadow-2xl border border-gray-200 max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <a href="mailto:support@cryptodxb.com" className="bg-gradient-to-r from-[#0F172A] to-[#1E293B] text-white font-bold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                                Contact Support
                            </a>
                            <a
                                href="/CryptoDXB About Us.docx"
                                target="_blank"
