...
const Investments = () => {
    ...
    const [network, setNetwork] = useState('BEP'); // Network State
    ...
    const handleSubmit = (e) => {
        ...
        if (!amount || isNaN(amount) || parseFloat(amount) < 2500) {
            setError('Minimum investment is $2500');
            return;
        }
                ...
                <div className="xl:col-span-2">
                    <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            {selectedMethod === 'USDT' && (
                                <div className="space-y-4">
                                    <label className="block text-sm font-semibold text-gray-700">Network</label>
                                    <div className="grid grid-cols-1 gap-4">
                                        <div className="rounded-xl p-4 border bg-gray-900 border-gray-900 text-white shadow-lg flex flex-col gap-2 cursor-default">
                                            <div className="flex items-center gap-3">
                                                <div className="w-5 h-5 rounded-full border flex items-center justify-center border-[#D4AF37]">
                                                    <div className="w-2.5 h-2.5 rounded-full bg-[#D4AF37]"></div>
                                                </div>
                                                <div>
                                                    <p className="font-bold">BEP</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2 md:col-span-2">
                                    <label className="text-sm font-semibold text-gray-700 flex justify-between">
                                        ...
                                        <span className="text-xs text-[#D4AF37] font-medium">Min: $2500</span>
                                    </label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
